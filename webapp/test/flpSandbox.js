		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "San Joaquin Form",
									"targetURL": "#Nmspsanjoaquin-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Nmspsanjoaquin-display": {
								"semanticObject": "Nmspsanjoaquin",
								"action": "display",
								"description": "SAN JOAQUIN FORM",
								"title": "San Joaquin Form",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Nmsp.sanjoaquin",
									"url": sap.ui.require.toUrl("Nmsp/sanjoaquin")
								}
							}
						}
					}
